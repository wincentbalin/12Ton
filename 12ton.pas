...
begin
 ...
 case neu of
  1:begin
     ...
     schalter(130,150,'šbernehmen');
    end;
  2:begin
     box(50,9,'Kontrolle von Zw”lfton-Reihen',true,p);
     schalter(130,150,'Testen');
    end;
  3:begin
     box(50,9,'Startreihe fr die Suche',true,p);
     schalter(130,150,'OK');
    end;
 end;
 schalter(280,150,'H”ren (F2)');
...
begin
 neuko12tr(3);
 box(50,10,'Zw”lftonreihen suchen',true,p);
...
begin
 box(27,7,'Tonl„nge (Metronomzahlen)',true,p);
 setcolor(f3);
 rectangle(258,121,384,133);
 schalter(222,142,'OK');
 schalter(340,142,'Abbrechen');
 mausanaus(false);
 outtextxy(312,123,'T”ne/min');
...
begin
 box(27,9,'Wieviele Reihen sp„ter?',true,p);
 setcolor(f3);
...
var p:pointer;
    i:byte;
begin
 box(50,16,'Informationen ber !12Ton',true,p);
 schalter(495,177,'OK');
 mausanaus(false);
 setcolor(fv);
 for i:=1 to 7 do
